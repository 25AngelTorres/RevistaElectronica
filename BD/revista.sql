...
INSERT INTO `articulo` (`id_articulo`, `nombre`, `resumen`, `abstrac`, `introduccion`, `metodologia`, `contenido`, `fecha_creacion`, `archivo_pdf`, `id_status`, `conclusiones`, `agradecimientos`, `referencias`) VALUES
